...
import { CfnUserPoolGroup, UserPool, UserPoolClient } from "aws-cdk-lib/lib/aws-cognito";
...
export class AuthorizerWrapper {
    ...
    private createUserPool(){
        this.userPool = new UserPool(this.scope, 'HotelUserPool', {
    ...
    private addUserPoolClient(){
        this.userPoolClient = this.userPool.addClient('HotelUserPool-client', {
            userPoolClientName: 'HotelUserPool-client',
            authFlows: {
    ...
    private createAuthorizer(){
        this.authorizer = new CognitoUserPoolsAuthorizer(this.scope, 'UserAuthorizer', {
            cognitoUserPools: [this.userPool],
            authorizerName: 'HotelUserAuthorizer',
